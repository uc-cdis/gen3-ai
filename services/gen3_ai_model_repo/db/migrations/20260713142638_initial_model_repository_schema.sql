...
CREATE TABLE IF NOT EXISTS model_repositories (
    ...
    CONSTRAINT model_repositories_unique
...
CREATE INDEX IF NOT EXISTS idx_model_repositories_current_revision
ON model_repositories (current_revision);

CREATE INDEX IF NOT EXISTS idx_model_repositories_created_at
ON model_repositories (created_at);
...
CREATE TABLE IF NOT EXISTS model_revisions (
    ...
    UNIQUE (repository_id, revision_identifier)
);

CREATE INDEX IF NOT EXISTS idx_model_revisions_repository
...
'Top-level AI model repositories similar to Hugging Face repositories';

COMMENT ON TABLE model_revisions IS
'Repository revisions such as main, v1, v2 or commit references';

COMMENT ON TABLE model_files IS
'Repository files mapped to object storage';
