...
def index_resource_from_name(index_name: str) -> str:
    """
    Build the Arborist resource path for a vector index.
...
async def parse_and_auth_request(request: Request, index_name: str):
    """
    ...
    resource = index_resource_from_name(index_name)
